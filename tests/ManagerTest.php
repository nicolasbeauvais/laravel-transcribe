...
//            ],
    ...
    public function testCreateFileIfNotExisting()
    {
        ...
        $this->assertFileExists($this->app['config']['transcribe.path'].'/en/user.php');
        $this->assertFileExists($this->app['config']['transcribe.path'].'/sp/user.php');
        $this->assertEquals('__UN_TOUCHED__', file_get_contents($this->app['config']['transcribe.path'].'/nl/user.php'));
        $this->assertEquals([], (array) include $this->app['config']['transcribe.path'].'/en/user.php');
    }
    ...
    public function testGetFileContentReadsContent()
    {
        ...
        $filePath = $this->app['config']['transcribe.path'].'/en/users.php';
    ...
    {
        $manager = m::mock('NicolasBeauvais\Transcribe\Manager[languages]', [new Filesystem(), '', []]);
