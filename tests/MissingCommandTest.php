...
class MissingCommandTest extends TestCase
{
    public function testCommandOutput()
    {
        ...
        $this->artisan('transcribe:missing');

        $missingENFile = (array) include $this->app['config']['transcribe.path'].'/en/missing.php';
        $missingNLFile = (array) include $this->app['config']['transcribe.path'].'/nl/missing.php';
        $userNlFile = (array) include $this->app['config']['transcribe.path'].'/nl/user.php';
        $productENFile = (array) include $this->app['config']['transcribe.path'].'/en/product.php';
        $productNlFile = (array) include $this->app['config']['transcribe.path'].'/nl/product.php';
    ...
    public function testAllowSeeTranslationInDefaultLanguage()
    {
        ...
        $this->artisan('transcribe:missing', ['--default' => true]);
    }
